  ...
  return (
      ...
      {Big && 
        <div className="fixed inset-0 bg-black  bg-opacity-50 cursor-pointer z-[11]" onClick={()=>setBig((prev)=>!prev)}>  
          ...
          <img src={img} alt="pop" className="z-[11]"  ></img>
          </div>
        </div>
      }
      <img src={img} alt="pop" className={`rounded-sm object-contain w-[200px] h-[196px] cursor-pointer z-10`} onClick={()=>setBig((prev)=>!prev)} ></img>
      </>
  )
}
